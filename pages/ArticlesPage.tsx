...
import { Search, Share2, Bookmark, Eye, Clock, FileText, PlusCircle, Sparkles, Camera, Plus } from 'lucide-react';
...
const ArticlesPage: React.FC<Props> = ({ onGoToMyPosts, onGoToCreatePost }) => {
  ...
  return (
    <div className="p-5 space-y-6 bg-[#F2F9F6] min-h-full">
      ...
      <div className="columns-2 gap-4 space-y-4">
        ...
        {/* Create Post Card - "Xiaohongshu Style" Entry */}
        <div 
